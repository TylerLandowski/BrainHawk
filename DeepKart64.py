from server import BizHawkTCPServer
from DQN import DQN
import numpy as np
from skimage.transform import resize

RECORDING = True  # If true, will record the experiences (to learn from human gameplay)
EXPERIENCES_NAME = "experiences"
TRAIN = True  # If true, will train the model
LOAD_DQN = False
MODEL_NAME = "dqn"
MODEL_TYPE = "micro_driver"
SCROT_Y = 60  # 120, 105
SCROT_X = 120  # 160, 140
SCROT_GRAY = True
STACK_SZ = 4
...
BizHawkTCPServer.update = update
print("Ready.")
